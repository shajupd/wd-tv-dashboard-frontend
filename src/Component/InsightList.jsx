  ...
  function handleFileChange(e) {
    ...
    reader.onload = function () {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        obj.qualityLeads = currentLine[4];
        obj.cac = currentLine[5];
        obj.payOnTime = currentLine[6];
        obj.budgetUtilization = currentLine[7];
        obj.clientProfitability = currentLine[8];
        obj.meetingAttendance = currentLine[9];
        obj.clientSupportResponse = currentLine[10];
